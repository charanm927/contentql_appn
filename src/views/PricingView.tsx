    ...
    <>
      ...
      >
        <div>
                  ...
                  <div className="col">
                    ...
                    >
                      ...
                      <div className="pricing-table-header">
                        ...
                        <div className="price">
                          ...
                          <p className="color--grey">
                            For professionals getting started with smaller
                            projects.
                          </p>
                        </div>
                        {/* Button */}
                      ...
                      <ul className="pricing-features color--black ico-10 ico--green mt-25">
                        ...
                        <li>
                          <p>
                            <span className="flaticon-check" /> 1 GB of cloud
                            storage
                          </p>
                        </li>
                        <li>
                        ...
                        <li className="disabled-option">
                          <p>
                            <span className="flaticon-check" /> Weekly data
                            backup
                          </p>
                        </li>
                        <li className="disabled-option">
                          <p>
                            <span className="flaticon-check" /> No Ads. No
                            trackers
                          </p>
                        </li>
                        <li>
                          <p>
                            <span className="flaticon-check" /> 12/5 email
                            support
                          </p>
                        </li>
                      </ul>
                    ...
                    >
                      ...
                      <div className="pricing-table-header">
                        ...
                        <div className="price">
                          ...
                          {/* Text */}
                          <p className="color--grey">
                            For personal use or small teams with simple
                            workflows.
                          </p>
                        </div>{" "}
                        {/* End Price */}
                      ...
                      <ul className="pricing-features color--black ico-10 ico--green mt-25">
                        <li>
                          <p>
                            <span className="flaticon-check" /> Up to 250
                            projects
                          </p>
                        </li>
                        <li>
                          <p>
                            <span className="flaticon-check" /> 15 GB of Cloud
                            Storage
                          </p>
                        </li>
                        <li>
                          <p>
                            <span className="flaticon-check" /> Shared team
                            workspace
                          </p>
                        </li>
                        <li>
                          <p>
                            <span className="flaticon-check" /> Daily data
                            backup
                          </p>
                        </li>
                        <li>
                        ...
                        <li>
                          <p>
                            <span className="flaticon-check" /> 12/7 email
                            support
                          </p>
                        </li>
                      </ul>
                    ...
                    >
                      ...
                      <div className="pricing-table-header">
                        ...
                        <div className="price">
                          ...
                          {/* Text */}
                          <p className="color--grey">
                            For growing teams that need more services and
                            flexibility.
                          </p>
                        </div>{" "}
                        {/* End Price */}
                      ...
                      <ul className="pricing-features color--black ico-10 ico--green mt-25">
                        <li>
                          <p>
                            <span className="flaticon-check" /> Everything in
                            Basic
                          </p>
                        </li>
                        <li>
                          <p>
                            <span className="flaticon-check" /> Private cloud
                            hosting
                          </p>
                        </li>
                        <li>
                        ...
                        <li>
                          <p>
                            <span className="flaticon-check" /> Advanced user
                            permissions
                          </p>
                        </li>
                        <li>
                          <p>
                            <span className="flaticon-check" /> Multi-team
                            management
                          </p>
                        </li>
                        <li>
                          <p>
                            <span className="flaticon-check" /> 24/7 Email
                            Support
                          </p>
                        </li>
                      </ul>
          ...
          <section
            id="comp-table"
            className="pt-100 pb-60 pricing-section division"
          >
            <div className="container">
              {/* SECTION TITLE */}
              <div className="row justify-content-center">
