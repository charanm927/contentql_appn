    ...
    <>
      ...
      >
        <div>
          <section
            id="download-1"
            className="gr--whitesmoke inner-page-hero download-section division"
          >
                  ...
                  <div className="version-release">
                    ...
                    <div className="release-data">
                      ...
                      <div className="rel">
                        ...
                        <span className="release-date">
                          2023-05-31 <span>68.91 MB</span>
                        </span>
                        <Link
                          href="download/example.zip"
                          download="example.zip"
                          className="btn btn--theme hover--tra-grey ico-20 ico-left release-download"
                        >
                          <span className="flaticon-down-arrow-1" /> Download
                          4.13.019
                        </Link>
                      </div>
                    </div>
                    ...
                    <div className="release-highlights">
                      <ul className="simple-list">
                        ...
                        <li className="list-item">
                          <p>
                            <b>Windows</b> - also available as a portable
                            version
                          </p>
                        </li>
                        <li className="list-item">
                  ...
                  <div className="version-release">
                    ...
                    <div className="release-data">
                      ...
                      <div className="rel">
                        ...
                        <span className="release-date">
                          2023-05-18 <span>62.46 MB</span>
                        </span>
                        <Link
                          href="download/example.zip"
                          download="example.zip"
                          className="btn btn--tra-grey hover--theme ico-20 ico-left release-download"
                        >
                          <span className="flaticon-down-arrow-1" /> Download
                          4.11.020
                        </Link>
                    ...
                    <div className="release-highlights">
                      <ul className="simple-list">
                        <li className="list-item">
                          <p>
                            Quaerat sodales sapien undo euismod purus and
                            blandit egestas magna on macOS 10.12.*
                          </p>
                        </li>
                        <li className="list-item">
                          <p>
                            Fixed suscipit lectus auctor integer cursus orci
                            vitae auctor integer
                          </p>
                        </li>
                        <li className="list-item">
                          <p>
                            Fixed Fringilla risus nec, luctus mauris auctor
                            integer an auctor cursus euismod
                          </p>
                        </li>
                        <li className="list-item">
                          <p>Fixed Crash#8341682687</p>
                        </li>
                      </ul>
                    </div>
                  </div>{" "}
                  ...
                  <div className="version-release">
                    ...
                    <div className="release-highlights">
                      <ul className="simple-list">
                        ...
                        <li className="list-item">
                          <p>
                            Fixed risus nec luctus mauris auctor integer an
                            integera congue magna
                          </p>
                        </li>
                        <li className="list-item">
                          <p>
                  ...
                  <div className="version-release">
                    ...
                    <div className="release-highlights">
                      <ul className="simple-list">
                        <li className="list-item">
                          <p>
                            Fixes integer cursus orci bugs on 10.13 (High
                            Sierra)
                          </p>
                        </li>
                        <li className="list-item">
                          <p>
                            Fixed auctor integer cursus orci vitae auctor
                            integer
                          </p>
                        </li>
                        <li className="list-item">
